      ...
      <footer>
        <section className="subscribe-section">
          ...
          <div className="social-container">
            <a href="https://www.facebook.com/madwallaceband/" target="_blank" ref="noopener noreferrer">
              <i className="fab fa-facebook-square" />
            </a>
            <a href="https://www.instagram.com/mad.wallace/" target="_blank" ref="noopener noreferrer">
              <i className="fab fa-instagram" />
            </a>
            <a href="https://open.spotify.com/artist/6H2CmXWubR7YVd6n1hlXq7" target="_blank" ref="noopener noreferrer">
              <i className="fab fa-spotify" />
            </a>
            <a href="mailto:madwallaceband@gmail.com">
              <i className="fas fa-envelope" />
            </a>
            <a href="https://www.youtube.com/channel/UC6N29y6h0Fqh7VmEObN6LHA" target="_blank" ref="noopener noreferrer">
              <i className="fab fa-youtube" />
            </a>
            <a href="https://www.youtube.com/watch?v=_lvB2tHSEG4" target="_blank" ref="noopener noreferrer">
